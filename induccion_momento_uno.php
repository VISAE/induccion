            ...
            <div >
                ...
                <div class="art-postcontent">
                    <div align="center">
                        ...
                        <img src="imagenes_curso/banner_momento1.jpg" alt="Momento 1" width="100%" height="60%" />
                        <table width="100%">
                            <tr>
                                <td>
                                    <form name="form1" method="post" target="_self" enctype="multipart/form-data" action="induccion_momento_uno_contenido.php">
                                        <p align="center">
