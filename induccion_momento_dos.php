            ...
            <div >
                ...
                <div class="art-postcontent">
                    <div align="center">
                        ...
                        <img src="imagenes_curso/banner_momento2.jpg" alt="Momento 2" width="100%" height="450" />
                        <table width="100%">
                            <tr>
                                <td>
                                    <form name="form1" method="post" target="_self" enctype="multipart/form-data" action="induccion_momento_dos_contenido.php">
                                        <p align="center">
                                            <select name="programa" id="programa" required="required" title="Por favor seleccione el programa Académico al cual pertenece" style="width: 600px" >
                                                <option value="">-- Seleccionar --</option>
                                                <?php
                                                $resultado = $consulta->consultarProgramas();
                                            ...
                                            <input type="submit" name="Submit2" value="Comenzar" class="boton_m2" >
                                        </p>
                                    </form>
                                </td>
                            </tr>
